<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-md overflow-hidden rounded-xl">
            ...
            <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">{{ __('登入帳戶') }}</h2>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-input id="email" class="block mt-1 w-full pl-10 border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                            type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="your-email@example.com" />
                    </div>
                </div>
            ...
            <div class="mt-8">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="bg-white px-3 text-gray-500">{{ __('或使用以下方式登入') }}</span>
                    </div>
                </div>
